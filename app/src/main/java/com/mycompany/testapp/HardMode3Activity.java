...
public class HardMode3Activity extends AppCompatActivity {
    public int score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_mode3);
        ...
        TextView questionText3 = (TextView) findViewById(R.id.txtquestion_number8);
        questionText3.setText(questionText3.getText() + " " +question+ " of " +questionTotal);

        TextView scoreText3 = (TextView) findViewById(R.id.txtScore8);
        scoreText3.setText(scoreText3.getText() + " " +score+ ""); // set the score from the previous intent

        final Chronometer timer3 = (Chronometer) findViewById(R.id.chronometer8);
        timer3.start();

        Button btn9 = (Button) findViewById(R.id.btnHard9);
        Button btn10 = (Button) findViewById(R.id.btnHard10);
        Button btn11 = (Button) findViewById(R.id.btnHard11);
        Button btn12 = (Button) findViewById(R.id.btnHard12);
    ...
    public void toResults (View view) {
        Intent i = new Intent (this, HardMode4Activity.class);
        Bundle b = new Bundle();
