...
public class HardMode1Activity extends AppCompatActivity {
    public int score = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_mode1);

        TextView questionText1 = (TextView) findViewById(R.id.txtquestion_number6);
        questionText1.setText(questionText1.getText() + " " +question+ " of " +questionTotal);

        TextView scoreText1 = (TextView) findViewById(R.id.txtScore6);
        scoreText1.setText(scoreText1.getText() + " " +score);

        final Chronometer timer = (Chronometer) findViewById(R.id.chronometer6);
        timer.start();

        Button btn1 = (Button) findViewById(R.id.btnHard1);
        Button btn2 = (Button) findViewById(R.id.btnHard2);
        Button btn3 = (Button) findViewById(R.id.btnHard3);
        Button btn4 = (Button) findViewById(R.id.btnHard4);
        ...
        btn2.setOnClickListener(new View.OnClickListener() { // correct answer
            @Override
    ...
    public void toResults (View view) {
        Intent i = new Intent (this, HardMode2Activity.class);
        Bundle b = new Bundle();
